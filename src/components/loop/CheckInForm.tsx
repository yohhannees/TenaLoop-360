  ...
  return (
    <section className="rounded-md border border-[#d8e4dc] bg-white p-4 shadow-sm">
      <div className="flex items-center justify-between gap-4">
        <div>
          <p className="text-sm font-medium uppercase text-[#64756b]">Daily check-in</p>
          <h2 className="text-2xl font-semibold">Today&apos;s inputs</h2>
        </div>
        <span className="rounded-md bg-[#0f6b52] px-3 py-2 text-sm font-semibold text-white">
          {score}/100
        </span>
      </div>
      ...
      <div className="mt-5 grid gap-5">
        ...
        <label className="grid gap-2 text-sm font-medium text-[#31463b]">
          ...
          <select
            ...
            className="h-11 rounded-md border border-[#cddbd3] bg-white px-3 text-sm text-[#23362c]"
          >
        ...
        {(checkIn.bpFocus || checkIn.glucoseFocus) && (
          <div className="grid gap-3 rounded-md border border-[#dde8e1] bg-[#fbfdfb] p-3">
            <p className="text-sm font-semibold text-[#284237]">Health self-log</p>
            {checkIn.bpFocus && (
              <label className="grid gap-1.5 text-sm font-medium text-[#31463b]">
                ...
                <input
                  ...
                  className="h-10 rounded-md border border-[#cddbd3] bg-white px-3 text-sm text-[#23362c] outline-none focus:border-[#0f6b52]"
                />
              </label>
            )}
